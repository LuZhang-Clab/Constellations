not succussfully use git to push homework code to a Github repository; (error: src refspec master does not match any). also not sure if I submitted it right.
